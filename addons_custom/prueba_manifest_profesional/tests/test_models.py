...
from .test_common import TestAddons_custom/prueba_manifest_profesionalCommon


@tagged('addons_custom/prueba_manifest_profesional', 'post_install', '-at_install')
class TestModels(TestAddons_custom/prueba_manifest_profesionalCommon):
...
class TestSecurity(TestAddons_custom/prueba_manifest_profesionalCommon):
